  ...
  return (
    <section className='rounded-div my-12 py-8 text-primary'>
        ...
        <div className='grid  md:grid-cols-2 lg:grid-cols-3 gap-4'>
            {trending?.map(coin => (
                <div key={coin.item.name} className='rounded-div flex justify-between p-4 hover:scale-105 ease-in-out duration-300'>
                    ...
                    <div>
                        <img src='https://assets.coingecko.com/coins/images/1/large/bitcoin.png?1547033579' alt='' className='w-6 mr-2' />
